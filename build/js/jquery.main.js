...
function initMixItUp() {
	...
	jQuery('.open-close .tabset li').each(function (e) {
		var category = jQuery(this);
		var linkCategory = category.attr('data-filter');
		var foo = linkCategory.split('-');
		...
		category.on('click', function() {
			...
			if (linkCategory === 'all') {
				btnMore.attr('href', `/works`)
			}
		});
	});


	jQuery('.home .mixitup').mixItUp({
		...
		loadmore: {
			...
			buttonClass: "loadmore-button btn btn-primary d-none",
