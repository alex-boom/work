...
function initLikeBtn() {
	jQuery('a.like-button').on('click', function() {
...
function initMixItUp() {
	jQuery('.mixitup').mixItUp({
		...
		loadmore: {
			...
			lessClass: "loadmore-less btn btn-primary d-none",
			lessLabel: "свернуть"
		}
	});
}
			...
			on: function() {
				jQuery('.open-close').openClose({
					...
					onInit: function(self) {
						var links = self.slider.find('.tabset li');
						self.opener.html(links.html());
 ...
 ;(function($, $win) {
 	...
 	var ContentLoaderProto = {
 		...
 		appendItems: function($newItems) {
			...
			this.makeCallback('appendNew', this);
		},
