		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Адрес', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[adress]" class="regular-text" type="text" name="sample_theme_options[adress]" 
						value="<?php esc_attr_e( $options['adress'] ); ?>" />
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'График работы отдела продаж', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[schedule]" class="regular-text" type="text" name="sample_theme_options[schedule]" 
						value="<?php esc_attr_e( $options['schedule'] ); ?>" />
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'Телефон-1', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[phone]" class="regular-text" type="text" name="sample_theme_options[phone]" 
						value="<?php esc_attr_e( $options['phone'] ); ?>" />
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'Телефон-2', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[phone-2]" class="regular-text" type="text" name="sample_theme_options[phone-2]" 
						value="<?php esc_attr_e( $options['phone-2'] ); ?>" />
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'E-mail', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[mail]" class="regular-text" type="text" name="sample_theme_options[mail]" 
						value="<?php esc_attr_e( $options['mail'] ); ?>" />
					</td>
				</tr>
